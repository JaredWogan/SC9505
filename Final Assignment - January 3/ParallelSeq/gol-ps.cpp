...
class SDLCamera {
    ...
    public:
        ...
        void fitToScreen() {
            ...
            double target_x = (double) this->screen_width / (this->default_cell_width * this->cells->global_num_cells_x);
            double target_y = (double) this->screen_width / (this->default_cell_height * this->cells->global_num_cells_y);
